...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--latent_dim", type=int, help="dimension of the latent space", default=4
    )
    ...
    parser.add_argument("--is_vae", type=str, help="is a vae", default="True")
...
def main(flags: argparse.Namespace):
    ...
    if is_vae:
        ...
        print("\nAE module\n")
        model = AEModule(
            in_channels=in_channels, img_size=img_size, latent_dim=flags.latent_dim
        )
        model_name = "ae"
