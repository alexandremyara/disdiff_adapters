...
class MultiDistillMeModule(LightningModule) :
    ...
    def log_gen_images(self) :
        ...
        for i in range(4) :
            images_cond_s_gen, _ = self.generate_cond(cond="s", pos=i)
        ...
        for i in range(4) :
            images_cond_t_gen, _ = self.generate_cond(cond="t", pos=i)
