...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--latent_dim_t", type=int, help="dimension of the latent space", default=4
    )
    ...
    parser.add_argument(
        "--factor", type=int, default=0, help="Choose a factor to encode"
    )
    ...
    parser.add_argument("--l_cov", type=float, default=1, help="use cross cov loss")

    parser.add_argument("--l_nce", type=float, default=1, help="use nce loss")

    parser.add_argument("--l_anti_nce", type=float, default=1, help="use anti nce loss")

    parser.add_argument(
        "--arch", type=str, default="def", help="Name of the architecture"
    )
    ...
    parser.add_argument("--version_model", type=str, default="md")
